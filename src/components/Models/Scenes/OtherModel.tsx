...
//@ts-expect-error
import {Neon_sun_moon} from '../RawModels/Neon_sun_moon.jsx'
...
const OtherModel = ({activeProject}: OtherModelProps) => {
      ...
      <Canvas camera={{ position: [1, 1, 2], fov: 35 }}>
        ...
        <Suspense fallback={null}>
          <Float rotationIntensity={ 0.4 } >
            <Neon_sun_moon animate={shouldAnimate} scale={isMobile ? 1 : 0.1} position={[0, isMobile ? 0 : 0, 0]} activeProject={activeProject}/>
          </Float>
          <PcLights />
        </Suspense>
