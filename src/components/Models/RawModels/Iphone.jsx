...
export function Iphone(props) {
  ...
  const screenTexture = useTexture('/domapp.jpeg');

  return (
    <group {...props} dispose={null}>
      <group position={[-12, -2.588, 5.419]}>
        <group rotation={[Math.PI / 1.98, 0, -1]}>
          <group rotation={[-Math.PI / 1.8, 0, -0.1]} scale={100}>
            ...
            <mesh
              ...
              // override default material with your image
            >
